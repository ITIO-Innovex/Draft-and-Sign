      ...
      <div className="App">
        ...
        <Routes>
          ...
          <Route path="/" element={
            ...
            <Route path="/documents" element={<ModuleLoader activeModule="phase2" />} />
            <Route path="/signatures" element={<ModuleLoader activeModule="phase3" />} />
            <Route path="/pdf-tools" element={<ModuleLoader activeModule="phase4" />} />
            <Route path="/templates" element={<ModuleLoader activeModule="phase5" />} />
            <Route path="/api-keys" element={<ModuleLoader activeModule="phase6" />} />
            <Route path="/analytics" element={<ModuleLoader activeModule="phase7" />} />
            <Route path="/platform-admin" element={<ModuleLoader activeModule="phase8" />} />
            ...
            <Route path="/signatures" element={<div className="text-center py-12"><h2 className="text-2xl font-bold text-gray-900">E-Signatures</h2><p className="text-gray-600 mt-2">Coming soon...</p></div>} />
            <Route path="/pdf-tools" element={<div className="text-center py-12"><h2 className="text-2xl font-bold text-gray-900">PDF Tools</h2><p className="text-gray-600 mt-2">Coming soon...</p></div>} />
            <Route path="/templates" element={<div className="text-center py-12"><h2 className="text-2xl font-bold text-gray-900">Templates</h2><p className="text-gray-600 mt-2">Coming soon...</p></div>} />
