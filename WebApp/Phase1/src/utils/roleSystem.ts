...
export const PERMISSIONS: Permission[] = [
  ...
  { id: 'templates_access', name: 'Templates', description: 'Templates', category: 'Templates' },
  { id: 'api_keys', name: 'API Keys', description: 'API keys', category: 'API' },
  { id: 'analytics_team', name: 'Team Analytics', description: 'Analytics', category: 'Analytics' },
